...
public class Main {
    public static void main(String[] args) {
        ...
        String weight = sc.nextLine(); //"napr 100 100 100"
        String[] splitString = weight.split(" ");// [100, 100, 100]

        ArrayList<Car> cars = new ArrayList<>();

        for (String s : splitString) { // pridam auto do listu
        ...
        while (true) {
            ...
            if (!doesCarExist(carId, cars)) {
                ...
                tempCar.setWeight(Double.parseDouble(input[1])); // +/- value
                /*isCarOverWeighted(cars);
                isCarWeightInMinus(cars);*/
            }
